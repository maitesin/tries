...
legend(loc='best')
grid(True)
savefig('../images/remove_not_found/random/remove_not_found_time_ALL.eps')
...
legend(loc='best')
grid(True)
savefig('../images/remove_not_found/random/remove_not_found_time_TRMU.eps')
...
legend(loc='best')
grid(True)
savefig('../images/remove_not_found/random/remove_not_found_time_RMU.eps')
...
legend(loc='best')
grid(True)
savefig('../images/remove_not_found/random/remove_not_found_time_TTR.eps')
