...
ylabel('Time(ms)')
title('Remove not found dictionary(' + dict + ')')
xticks(index, ('Trie', 'TST', 'Radix', 'Map', 'Umap'))
legend(loc='best')
grid(True)

savefig('../images/remove_not_found/dict/remove_not_found_' + dict  + '_time_ALL.eps')
...
savefig('../images/remove_not_found/dict/remove_not_found_' + dict  + '_time_TTR.eps')
