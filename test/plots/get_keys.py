...
legend(loc='best')
grid(True)
savefig('../images/get_keys/random/get_keys_time_ALL.eps')
...
legend(loc='best')
grid(True)
savefig('../images/get_keys/random/get_keys_time_TRMU.eps')
...
legend(loc='best')
grid(True)
savefig('../images/get_keys/random/get_keys_time_RMU.eps')
...
legend(loc='best')
grid(True)
savefig('../images/get_keys/random/get_keys_time_TTR.eps')
